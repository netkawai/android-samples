...
class VideoDetailsFragment : DetailsSupportFragment() {
    ...
    private var mSelectedMovie: DisplayedTimeZoneClock? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedMovie = activity!!.intent.getSerializableExtra(DetailsActivity.MOVIE) as DisplayedTimeZoneClock
    ...
    private fun initializeBackground(movie: DisplayedTimeZoneClock?) {
    ...
    private fun setupRelatedMovieListRow() {
        ...
        val list = DisplayTimeZoneList.list
    ...
    private inner class ItemViewClickedListener : OnItemViewClickedListener {
        override fun onItemClicked(
                ...
                row: Row) {
            if (item is DisplayedTimeZoneClock) {
