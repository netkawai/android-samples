...
object DisplayTimeZoneList {
    ...
    val list: List<DisplayedTimeZoneClock> by lazy {
        setupMovies()
    }
    private var count: Long = 0

    private fun setupMovies(): List<DisplayedTimeZoneClock> {
        val title = arrayOf(
    ...
    ): DisplayedTimeZoneClock {
        val movie = DisplayedTimeZoneClock()
        movie.id = count++
        movie.title = title
